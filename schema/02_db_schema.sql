...
) ENGINE=InnoDB AUTO_INCREMENT=8146442 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
--
-- Table structure for table `TEMP_OUTSIDE_WALL_START_POINTS`
--

DROP TABLE IF EXISTS `TEMP_OUTSIDE_WALL_START_POINTS`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `TEMP_OUTSIDE_WALL_START_POINTS` (
  `CELL_ID` bigint(20) unsigned NOT NULL,
  `X` bigint(20) unsigned NOT NULL,
  `Y` bigint(20) unsigned NOT NULL,
  `CELL_TYPE` varchar(20) NOT NULL,
  PRIMARY KEY (`CELL_ID`),
  UNIQUE KEY `TEMP_UNIQUE_ALL_CELL` (`CELL_ID`,`X`,`Y`),
  KEY `TEMP_CELL_XY` (`X`,`Y`) USING HASH
...
CREATE TABLE `TEMP_UNUSED_START_POINTS` (
  ...
  PRIMARY KEY (`CELL_ID`),
  UNIQUE KEY `TEMP_UNIQUE_ALL_CELL` (`CELL_ID`,`X`,`Y`),
  KEY `TEMP_UNIQUE_CELL` (`X`,`Y`) USING HASH
) ENGINE=MEMORY DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=12522 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-01-28 21:08:00
